...
module.exports = {
    ...
    head: [
        ...
        ['link', { rel: 'icon', href: '/king-note/icon-256x256.png' }],
        ['link', { rel: 'manifest', href: '/king-note/manifest.json' }],
        ['meta', { name: 'theme-color', content: '#3eaf7c' }],
        ['meta', { name: 'apple-mobile-web-app-capable', content: 'yes' }],
        ['meta', { name: 'apple-mobile-web-app-status-bar-style', content: 'black' }],
        ['link', { rel: 'apple-touch-icon', href: '/king-note/icon-192x192.png' }],
        ['link', { rel: 'mask-icon', href: '/king-note//safari-pinned-tab.svg', color: '#3eaf7c' }],
        ['meta', { name: 'msapplication-TileImage', content: '/king-note/icon-192x192.png' }],
